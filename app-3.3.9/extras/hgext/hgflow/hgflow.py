...
def _get_context( repo, rev ) :
    # As of hg v4.7, `repo' will raise `error.ProgrammingError' when a branch name is passed in as `changeid'.
    try :
        return repo[rev]
    except (error.ProgrammingError if ("4.7" <= util.version()) else None) :
